  ...
  d.flexslider = function (i, k) {
    ...
    f = {
      init: function () {
        ...
        b.transitions = g;
        '' !== c.controlsContainer &&
          (a.controlsContainer = 0 < d(c.controlsContainer).length && d(c.controlsContainer));
        ...
        setup: function () {
          ...
          a.slides.click(function (b) {
            ...
            !d(c.asNavFor).data('flexslider').animating &&
              !b.hasClass('active') &&
              ((a.direction = a.currentItem < g ? 'next' : 'prev'), a.flexAnimate(g, c.pauseOnAction, !1, !0, !0));
          });
        },
      },
      controlNav: {
        ...
        setupPaging: function () {
          ...
          a.controlNavScaffold = d(
            '<ol class="' +
              ...
              'control-nav ' +
              e +
              ('thumbnails' === c.controlNav ? 'control-thumbs' : 'control-paging') +
              '"></ol>',
          );
          if (1 < a.pagingCount)
          ...
          a.controlNavScaffold.delegate('a, img', s, function (b) {
            ...
            b.hasClass(e + 'active') ||
              ((a.direction = g > a.currentSlide ? 'next' : 'prev'), a.flexAnimate(g, c.pauseOnAction));
          });
          r &&
            a.controlNavScaffold.delegate('a', 'click touchstart', function (a) {
              a.preventDefault();
            });
        },
        setupManual: function () {
          ...
          a.controlNav.live(s, function (b) {
            ...
            var b = d(this),
              g = a.controlNav.index(b);
            b.hasClass(e + 'active') ||
              (g > a.currentSlide ? (a.direction = 'next') : (a.direction = 'prev'), a.flexAnimate(g, c.pauseOnAction));
          });
          r &&
        ...
        set: function () {
          a.controlNav = d(
            '.' + e + 'control-nav li ' + ('thumbnails' === c.controlNav ? 'img' : 'a'),
        ...
        setup: function () {
          ...
          a.controlsContainer
            ? (d(a.controlsContainer).append(b),
              (a.directionNav = d('.' + e + 'direction-nav li a', a.controlsContainer)))
            : (a.append(b), (a.directionNav = d('.' + e + 'direction-nav li a', a)));
      ...
      touch: function () {
          ...
          if (!p || 500 < Number(new Date()) - k)
            b.preventDefault(),
              !q &&
                ...
                (c.animationLoop ||
                  (j /=
                    (0 === a.currentSlide && 0 > j) || (a.currentSlide === a.last && 0 < j) ? Math.abs(j) / o + 2 : 1),
        ...
        function g() {
          if (a.animatingTo === a.currentSlide && !p && null !== j) {
            ...
            a.canAdvance(l) && ((550 > Number(new Date()) - k && 50 < Math.abs(h)) || Math.abs(h) > o / 2)
              ? a.flexAnimate(l, c.pauseOnAction)
              : a.flexAnimate(a.currentSlide, c.pauseOnAction, !0);
          }
              ...
              : 1 === j.touches.length &&
                ...
                (f =
                  h && m && a.animatingTo === a.last
                    ...
                    : m
                    ? (a.last - a.currentSlide + a.cloneOffset) * o
                    : (a.currentSlide + a.cloneOffset) * o),
      ...
      if (!a.animating && (a.canAdvance(b, k) || n) && a.is(':visible')) {
        ...
        if (q)
          ...
          h
            ...
            : (b =
                0 === a.currentSlide && b === a.count - 1 && c.animationLoop && 'next' !== a.direction
                  ? m
                    ? (a.count + a.cloneOffset) * o
                    : 0
                  : a.currentSlide === a.last && 0 === b && c.animationLoop && 'prev' !== a.direction
                  ? m
                    ? 0
                    : (a.count + 1) * o
                  : m
                  ? (a.count - 1 - b + a.cloneOffset) * o
                  : (b + a.cloneOffset) * o);
    ...
    a.wrapup = function (b) {
      !q &&
        ...
        (0 === a.currentSlide && a.animatingTo === a.last && c.animationLoop
          ...
          : a.currentSlide === a.last && 0 === a.animatingTo && c.animationLoop && a.setProps(b, 'jumpStart'));
      a.animating = !1;
    ...
    a.canAdvance = function (b, g) {
      ...
      return g
        ? !0
        : p && a.currentItem === a.count - 1 && 0 === b && 'prev' === a.direction
        ? !0
        : p && 0 === a.currentItem && b === a.pagingCount - 1 && 'next' !== a.direction
        ? !1
        : b === a.currentSlide && !p
        ? !1
        : c.animationLoop
    ...
    a.setup = function (b) {
      if (q)
        ...
        'init' === b &&
          ...
          (a.cloneCount = 0),
          (a.cloneOffset = 0),
          m && ((n = d.makeArray(a.slides).reverse()), (a.slides = d(n)), a.container.empty().append(a.slides)));
        c.animationLoop &&
          !h &&
          ((a.cloneCount = 2),
          (a.cloneOffset = 1),
    ...
    a.update = function (b, d) {
      a.doMath();
      h ||
        (b < a.currentSlide ? (a.currentSlide += 1) : b <= a.currentSlide && 0 !== b && (a.currentSlide -= 1),
        (a.animatingTo = a.currentSlide));
