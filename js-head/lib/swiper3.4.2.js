    ...
    a = function (s, i) {
      ...
      function p(e) {
        ...
        if (
          ...
          T.isHorizontal()
            ...
            : ((38 !== a && 40 !== a) || (e.preventDefault ? e.preventDefault() : (e.returnValue = !1)),
              40 === a && T.slideNext(),
              38 === a && T.slidePrev()),
      ...
      if (
        ...
        (T.container[0].swiper = T),
          ...
          T.support.flexbox ||
            (T.classNames.push(T.params.containerModifierClass + 'no-flexbox'), (T.params.slidesPerColumn = 1)),
          T.params.autoHeight && T.classNames.push(T.params.containerModifierClass + 'autoheight'),
          (T.params.parallax || T.params.watchSlidesVisibility) && (T.params.watchSlidesProgress = !0),
          T.params.touchReleaseOnEdges && (T.params.resistanceRatio = 0),
          ['cube', 'coverflow', 'flip'].indexOf(T.params.effect) >= 0 &&
            (T.support.transforms3d
              ? ((T.params.watchSlidesProgress = !0), T.classNames.push(T.params.containerModifierClass + '3d'))
          ...
          (T.rtl =
            T.isHorizontal() && ('rtl' === T.container[0].dir.toLowerCase() || 'rtl' === T.container.css('direction'))),
            ...
            function e() {
              void 0 !== T &&
                ...
                T.imagesLoaded === T.imagesToLoad.length &&
                  (T.params.updateOnImagesReady && T.update(), T.emit('onImagesReady', T)));
            }
          ...
          (T.updateContainerSize = function () {
            ...
            (e = void 0 !== T.params.width ? T.params.width : T.container[0].clientWidth),
              ...
              (0 === e && T.isHorizontal()) ||
                (0 === a && !T.isHorizontal()) ||
                ((e =
                  e - parseInt(T.container.css('padding-left'), 10) - parseInt(T.container.css('padding-right'), 10)),
                (a =
                  a - parseInt(T.container.css('padding-top'), 10) - parseInt(T.container.css('padding-bottom'), 10)),
                (T.width = e),
                (T.height = a),
            ...
            if (void 0 !== T.size) {
              ...
              T.params.slidesPerColumn > 1 &&
                ...
                'auto' !== T.params.slidesPerView &&
                  ...
                  (n = Math.max(n, T.params.slidesPerView * T.params.slidesPerColumn)));
              var o,
              ...
              for (e = 0; e < T.slides.length; e++) {
                  ...
                  'column' === T.params.slidesPerColumnFill
                    ...
                    u
                      .css(
                        ...
                        0 !== h && T.params.spaceBetween && T.params.spaceBetween + 'px',
                      )
                ...
                'none' !== u.css('display') &&
                  ('auto' === T.params.slidesPerView
                    ? ((o = T.isHorizontal() ? u.outerWidth(!0) : u.outerHeight(!0)),
              ...
              if (
                (T.rtl &&
                  T.wrongRTL &&
                  ('slide' === T.params.effect || 'coverflow' === T.params.effect) &&
              ...
              if (!T.params.centeredSlides) {
                ...
                (T.snapGrid = g),
                  Math.floor(T.virtualSize - T.size) - Math.floor(T.snapGrid[T.snapGrid.length - 1]) > 1 &&
          ...
          (T.updateSlidesProgress = function (e) {
            if ((void 0 === e && (e = T.translate || 0), 0 !== T.slides.length)) {
              ...
              for (var t = 0; t < T.slides.length; t++) {
                var s = T.slides[t],
                  i =
                    (a + (T.params.centeredSlides ? T.minTranslate() : 0) - s.swiperSlideOffset) /
                    (s.swiperSlideSize + T.params.spaceBetween);
                if (T.params.watchSlidesVisibility) {
                  var r = -(a - s.swiperSlideOffset),
                    n = r + T.slidesSizesGrid[t];
                  ((r >= 0 && r < T.size) || (n > 0 && n <= T.size) || (r <= 0 && n >= T.size)) &&
          ...
          (T.updateClasses = function () {
            ...
            if (
              ...
              var r,
                n = T.params.loop
                  ? Math.ceil((T.slides.length - 2 * T.loopedSlides) / T.params.slidesPerGroup)
                  : T.snapGrid.length;
              if (
                (T.params.loop
                ...
                'fraction' === T.params.paginationType &&
                  (T.paginationContainer.find('.' + T.params.paginationCurrentClass).text(r + 1),
              ...
              'custom' === T.params.paginationType &&
                ...
                (T.paginationContainer.html(T.params.paginationCustomRender(T, r + 1, n)),
          ...
          window.navigator.pointerEnabled
            ...
            : window.navigator.msPointerEnabled &&
              (T.touchEventsDesktop = { start: 'MSPointerDown', move: 'MSPointerMove', end: 'MSPointerUp' }),
          (T.touchEvents = {
          ...
          (window.navigator.pointerEnabled || window.navigator.msPointerEnabled) &&
            ('container' === T.params.touchEventsTarget ? T.container : T.wrapper).addClass(
              'swiper-wp8-' + T.params.direction,
            ),
          (T.initEvents = function (e) {
            ...
            window[t]('resize', T.onResize),
              ...
              T.params.pagination &&
                ...
                T.params.a11y &&
                  T.a11y &&
                  T.paginationContainer[a]('keydown', '.' + T.params.bulletClass, T.a11y.onEnterKey)),
        ...
        (T.onTouchStart = function (a) {
          ...
          (T.onTouchMove = function (a) {
            if ((a.originalEvent && (a = a.originalEvent), !X || 'mousemove' !== a.type)) {
              ...
              if (X && T.params.touchReleaseOnEdges && !T.params.loop)
                if (T.isHorizontal()) {
                  if (
                    (T.touches.currentX < T.touches.startX && T.translate <= T.maxTranslate()) ||
                    (T.touches.currentX > T.touches.startX && T.translate >= T.minTranslate())
                  )
                    return;
                } else if (
                  (T.touches.currentY < T.touches.startY && T.translate <= T.maxTranslate()) ||
                  (T.touches.currentY > T.touches.startY && T.translate >= T.minTranslate())
                )
                  return;
              ...
              if ((z && T.emit('onTouchMove', T, a), !(a.targetTouches && a.targetTouches.length > 1))) {
                if (
                  ...
                  var t;
                  (T.isHorizontal() && T.touches.currentY === T.touches.startY) ||
                ...
                if (
                  ...
                  void 0 === A &&
                    ((T.touches.currentX === T.touches.startX && T.touches.currentY === T.touches.startY) || (A = !0)),
                  S)
                ) {
                  ...
                  if (A) {
                    (T.allowClick = !1),
                      ...
                      C ||
                        ...
                        T.params.autoplay &&
                          T.autoplaying &&
                          (T.params.autoplayDisableOnInteraction ? T.stopAutoplay() : T.pauseAutoplay()),
                        (D = !1),
                        !T.params.grabCursor ||
                    ...
                    if (
                      (s > 0 && P > T.minTranslate()
                        ? ((r = !1),
                          T.params.resistance &&
                            (P = T.minTranslate() - 1 + Math.pow(-T.minTranslate() + I + s, T.params.resistanceRatio)))
                        : s < 0 &&
                          P < T.maxTranslate() &&
                          ((r = !1),
                          T.params.resistance &&
                            (P = T.maxTranslate() + 1 - Math.pow(T.maxTranslate() - I - s, T.params.resistanceRatio))),
                    ...
                    T.params.followFinger &&
                      ...
                      T.params.freeMode &&
                        (0 === G.length &&
                          G.push({ position: T.touches[T.isHorizontal() ? 'startX' : 'startY'], time: M }),
                        G.push({
                ...
                if (T.params.freeModeMomentum) {
                  ...
                  if (u < T.maxTranslate())
                    T.params.freeModeMomentumBounce
                      ? (u + T.maxTranslate() < -h && (u = T.maxTranslate() - h),
                        (c = T.maxTranslate()),
                        (m = !0),
                        (D = !0))
                      : (u = T.maxTranslate());
                    ...
                    (u =
                      Math.abs(T.snapGrid[g] - u) < Math.abs(T.snapGrid[g - 1] - u) || 'next' === T.swipeDirection
                        ? T.snapGrid[g]
                        : T.snapGrid[g - 1]),
                      T.rtl || (u = -u);
                  }
              ...
              for (v = 0; v < T.slidesGrid.length; v += T.params.slidesPerGroup)
                void 0 !== T.slidesGrid[v + T.params.slidesPerGroup]
                  ? i >= T.slidesGrid[v] &&
                    ...
                    ((w = v), (y = T.slidesGrid[v + T.params.slidesPerGroup] - T.slidesGrid[v]))
                  : i >= T.slidesGrid[v] &&
                    ((w = v), (y = T.slidesGrid[T.slidesGrid.length - 1] - T.slidesGrid[T.slidesGrid.length - 2]));
              var x = (i - T.slidesGrid[w]) / y;
              if (s > T.params.longSwipesMs) {
                if (!T.params.longSwipes) return void T.slideTo(T.activeIndex);
                'next' === T.swipeDirection &&
                  (x >= T.params.longSwipesRatio ? T.slideTo(w + T.params.slidesPerGroup) : T.slideTo(w)),
                  'prev' === T.swipeDirection &&
                    (x > 1 - T.params.longSwipesRatio ? T.slideTo(w + T.params.slidesPerGroup) : T.slideTo(w));
              } else {
          ...
          (T.slideTo = function (e, a, t, s) {
            ...
            if (
              (T.params.autoplay &&
                T.autoplaying &&
                (s || !T.params.autoplayDisableOnInteraction ? T.pauseAutoplay(a) : T.stopAutoplay()),
              T.updateProgress(i),
          ...
          (T.setWrapperTranslate = function (e, a, t) {
            ...
            T.isHorizontal() ? (s = T.rtl ? -e : e) : (i = e),
              ...
              T.params.virtualTranslate ||
                (T.support.transforms3d
                  ? T.wrapper.transform('translate3d(' + s + 'px, ' + i + 'px, 0px)')
                ...
                : ((i = window.getComputedStyle(e, null)),
                  window.WebKitCSSMatrix
                    ...
                    : ((r =
                      ...
                      (t = r.toString().split(','))),
                  'x' === a &&
                    (s = window.WebKitCSSMatrix ? r.m41 : 16 === t.length ? parseFloat(t[12]) : parseFloat(t[4])),
                  'y' === a &&
                    (s = window.WebKitCSSMatrix ? r.m42 : 16 === t.length ? parseFloat(t[13]) : parseFloat(t[5])),
                  T.rtl && s && (s = -s),
                  s || 0)
            );
          }),
          ...
          (T.fixLoop = function () {
            ...
            T.activeIndex < T.loopedSlides
              ? ((e = T.slides.length - 3 * T.loopedSlides + T.activeIndex),
                (e += T.loopedSlides),
                T.slideTo(e, 0, !1, !0))
              : (('auto' === T.params.slidesPerView && T.activeIndex >= 2 * T.loopedSlides) ||
                  T.activeIndex > T.slides.length - 2 * T.params.slidesPerView) &&
              ...
              setTranslate: function () {
                for (var a = 0; a < T.slides.length; a++) {
                  ...
                  if (
                    ...
                    0 === d.length &&
                      ((d = e('<div class="swiper-slide-shadow-' + (T.isHorizontal() ? 'left' : 'top') + '"></div>')),
                      t.append(d)),
                      0 === u.length &&
                        ((u = e(
              ...
              setTranslate: function () {
                ...
                T.params.cube.shadow &&
                  (T.isHorizontal()
                    ...
                    : ((a = T.container.find('.swiper-cube-shadow')),
                      0 === a.length && ((a = e('<div class="swiper-cube-shadow"></div>')), T.container.append(a))));
                for (var s = 0; s < T.slides.length; s++) {
                  ...
                  var u =
                    ...
                    'px)';
                  if (
                    (o <= 1 && o > -1 && ((t = 90 * s + 90 * o), T.rtl && (t = 90 * -s - 90 * o)),
                    i.transform(u),
                    ...
                    0 === c.length &&
                      ((c = e('<div class="swiper-slide-shadow-' + (T.isHorizontal() ? 'left' : 'top') + '"></div>')),
                      i.append(c)),
                      0 === m.length &&
                        ((m = e(
                          '<div class="swiper-slide-shadow-' + (T.isHorizontal() ? 'right' : 'bottom') + '"></div>',
            ...
            coverflow: {
              setTranslate: function () {
                for (
                  ...
                  var f =
                    'translate3d(' + g + 'px,' + h + 'px,' + m + 'px)  rotateX(' + c + 'deg) rotateY(' + u + 'deg)';
                  if (
                    (o.transform(f), (o[0].style.zIndex = 1 - Math.abs(Math.round(d))), T.params.coverflow.slideShadows)
                  ) {
                    ...
                    0 === v.length &&
                      ((v = e('<div class="swiper-slide-shadow-' + (T.isHorizontal() ? 'left' : 'top') + '"></div>')),
                      o.append(v)),
                      0 === w.length &&
                        ((w = e(
                          '<div class="swiper-slide-shadow-' + (T.isHorizontal() ? 'right' : 'bottom') + '"></div>',
            ...
            onTransitionStart: function () {
              T.params.lazyLoading &&
                (T.params.lazyLoadingOnTransitionStart ||
                  (!T.params.lazyLoadingOnTransitionStart && !T.lazy.initialImageLoaded)) &&
                T.lazy.load();
            },
            ...
            set: function () {
              if (T.params.scrollbar) {
                ...
                (a.track = e(T.params.scrollbar)),
                  ...
                  0 === a.drag.length &&
                    ((a.drag = e('<div class="swiper-scrollbar-drag"></div>')), a.track.append(a.drag)),
              ...
              if (T.params.scrollbar) {
                ...
                (e = (a.trackSize - a.dragSize) * T.progress),
                  T.rtl && T.isHorizontal()
                    ? ((e = -e),
                      e > 0 ? ((t = a.dragSize - e), (e = 0)) : -e + a.dragSize > a.trackSize && (t = a.trackSize + e))
                    : e < 0
                    ? ((t = a.dragSize + e), (e = 0))
              ...
              function s(a) {
                (e = a.rtl && 'horizontal' === a.params.direction ? -T.translate : T.translate),
                  'slide' === T.params.controlBy &&
                    (T.controller.getInterpolateFunction(a), (r = -T.controller.spline.interpolate(-e))),
          ...
          (T.hashnav = {
            onHashCange: function (e, a) {
              ...
              t !== T.slides.eq(T.activeIndex).attr('data-hash') &&
                T.slideTo(T.wrapper.children('.' + T.params.slideClass + '[data-hash="' + t + '"]').index());
            },
              ...
              if (T.params.history) {
                ...
                (T.history.initialized = !0),
                  ...
                  (this.paths.key || this.paths.value) &&
                    (this.scrollToSlide(0, this.paths.value, T.params.runCallbacksOnInit),
          ...
          (T.disableMousewheelControl = function () {
            ...
            var a = T.container;
            return (
              'container' !== T.params.mousewheelEventsTarged && (a = e(T.params.mousewheelEventsTarged)),
            ...
            setTranslate: function () {
              T.container
                ...
                T.slides.each(function () {
                  var a = e(this);
                  a.find('[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]').each(
                    function () {
            ...
            onGestureChange: function (e) {
              ...
              a.gesture.image &&
                ...
                (T.support.gestures
                  ...
                  : (a.scale = (a.gesture.scaleMove / a.gesture.scaleStart) * a.currentScale),
                a.scale > a.gesture.zoomMax &&
                  (a.scale = a.gesture.zoomMax - 1 + Math.pow(a.scale - a.gesture.zoomMax + 1, 0.5)),
                a.scale < T.params.zoomMin &&
                  (a.scale = T.params.zoomMin + 1 - Math.pow(T.params.zoomMin - a.scale + 1, 0.5)),
                a.gesture.image.transform('translate3d(0,0,0) scale(' + a.scale + ')'));
            },
            onGestureEnd: function (e) {
              var a = T.zoom;
              (!T.support.gestures &&
                ('touchend' !== e.type || ('touchend' === e.type && e.changedTouches.length < 2))) ||
                (a.gesture.image &&
                  0 !== a.gesture.image.length &&
                ...
                if (!(t < a.gesture.slideWidth && s < a.gesture.slideHeight)) {
                  ...
                  e.preventDefault(),
                    ...
                    a.image.currentX < a.image.minX &&
                      (a.image.currentX = a.image.minX + 1 - Math.pow(a.image.minX - a.image.currentX + 1, 0.8)),
                    a.image.currentX > a.image.maxX &&
                      (a.image.currentX = a.image.maxX - 1 + Math.pow(a.image.currentX - a.image.maxX + 1, 0.8)),
                    a.image.currentY < a.image.minY &&
                      (a.image.currentY = a.image.minY + 1 - Math.pow(a.image.minY - a.image.currentY + 1, 0.8)),
                    a.image.currentY > a.image.maxY &&
                      (a.image.currentY = a.image.maxY - 1 + Math.pow(a.image.currentY - a.image.maxY + 1, 0.8)),
                    a.velocity.prevPositionX || (a.velocity.prevPositionX = a.image.touchesCurrent.x),
                    a.velocity.prevPositionY || (a.velocity.prevPositionY = a.image.touchesCurrent.y),
                    a.velocity.prevTime || (a.velocity.prevTime = Date.now()),
                    (a.velocity.x =
                      (a.image.touchesCurrent.x - a.velocity.prevPositionX) / (Date.now() - a.velocity.prevTime) / 2),
                    (a.velocity.y =
                      (a.image.touchesCurrent.y - a.velocity.prevPositionY) / (Date.now() - a.velocity.prevTime) / 2),
            ...
            onTouchEnd: function (e, a) {
              ...
              if (t.gesture.image && 0 !== t.gesture.image.length) {
                ...
                (t.image.minX = Math.min(t.gesture.slideWidth / 2 - d / 2, 0)),
                  ...
                  t.gesture.imageWrap
                    .transition(p)
                    .transform('translate3d(' + t.image.currentX + 'px, ' + t.image.currentY + 'px,0)');
              }
            },
            ...
            toggleZoom: function (a, t) {
              ...
              if (
                ...
                void 0 === s.image.touchesStart.x && t
                  ? ((i = 'touchend' === t.type ? t.changedTouches[0].pageX : t.pageX),
        ...
        return (
          (T.callPlugins = function (e) {
            for (var a = 0; a < T._plugins.length; a++)
              e in T._plugins[a] &&
                T._plugins[a][e](arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]);
          }),
          ...
          (T.a11y = {
            ...
            onEnterKey: function (a) {
              13 === a.keyCode &&
                (e(a.target).is(T.params.nextButton)
                  ? (T.onClickNext(a),
                    T.isEnd ? T.a11y.notify(T.params.lastSlideMessage) : T.a11y.notify(T.params.nextSlideMessage))
            ...
            liveRegion: e(
              '<span class="' + T.params.notificationClass + '" aria-live="assertive" aria-atomic="true"></span>',
            ),
            notify: function (e) {
          ...
          (T.init = function () {
            T.params.loop && T.createLoop(),
              ...
              T.params.scrollbar &&
                T.scrollbar &&
                (T.scrollbar.set(), T.params.scrollbarDraggable && T.scrollbar.enableDraggable()),
              'slide' !== T.params.effect &&
                T.effects[T.params.effect] &&
                (T.params.loop || T.updateProgress(), T.effects[T.params.effect].setTranslate()),
              T.params.loop
                ...
                : (T.slideTo(T.params.initialSlide, 0, T.params.runCallbacksOnInit),
                  0 === T.params.initialSlide &&
                    (T.parallax && T.params.parallax && T.parallax.setTranslate(),
          ...
          (T.cleanupStyles = function () {
            T.container.removeClass(T.classNames.join(' ')).removeAttr('style'),
              ...
              T.paginationContainer &&
                ...
                T.paginationContainer.removeClass(T.params.paginationHiddenClass),
          ...
          (T.destroy = function (e, a) {
            T.detachEvents(),
              ...
              T.params.history &&
                !T.params.replaceState &&
                window.removeEventListener('popstate', T.history.setHistoryPopState),
            ...
            on: function (e, t, s, i) {
              ...
              for (n = 0; n < this.length; n++)
                if ('function' == typeof t || t === !1)
                  for (
                    'function' == typeof t && ((s = arguments[1]), (i = arguments[2] || !1)), o = 0;
                    o < l.length;
                    o++
                  )
